<template>
  <article class="player-card team-card NBA" ref="card">
    <TeamMetaBar :team="team" :teamId="teamId" />
    <div class="player-card__image-info team-card__image-info">      
      <div class="player-card__image-column team-card__image-column team-card__image-column" v-if="['mobile', 'tablet'].indexOf($mq) < 0">
