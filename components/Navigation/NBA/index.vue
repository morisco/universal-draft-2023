  ...
  computed: {
    ...
    navOptions() {
      return this.pageSettings ? [
        ...
        {to: '/draft-grades', title: 'Draft Grades', subtitle:'by Danny Chau', enabled: this.pageSettings.enable_results, updated: this.pageSettings.draft_results_updated, routeNames: ['draft-grades', 'draft_results_player_share']}
      ] : null;
    }
  },
  watch: {
