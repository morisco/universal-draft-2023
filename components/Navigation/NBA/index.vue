  ...
  computed: {
    ...
    navOptions() {
      return this.pageSettings ? [
        ...
        {to: '/team-needs', title: 'Team Needs', subtitle:'By Kevin O\'Connor', enabled: this.pageSettings.breakdown_by_team, updated: this.pageSettings.breakdown_updated, routeNames: ['team-needs', 'team_needs_team_share']},
