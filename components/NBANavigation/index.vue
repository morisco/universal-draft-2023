...
<div class="navigation" id="navigation" :class="[advanceClass, ...{'navigation--fixed': fixed}]" ref="navigation">
  <div class="navigation__sticky" v-bind:style="[fixed ? {width: width + 'px', maxWidth: maxWidth + 'px'} : {width: width, maxWidth: maxWidth}]">
    <a href="https://theringer.com" target="_blank" class="navigation__ringer-home">
      <img src="@/assets/img/ringer-circle-orange.svg" v-if="league === 'nba'" alt="The Ringer 'R' Logo" />
      <img src="@/assets/img/ringer-circle-white.svg" v-if="league === 'nfl'" alt="The Ringer 'R' Logo" />
    </a>
  ...
  computed: {
    ...
    navOptions() {
      return this.pageSettings ? [
        ...
        {to: '/team-needs', title: 'Team Needs', subtitle:'by Matt Dollinger', enabled: this.pageSettings.breakdown_by_team, updated: this.pageSettings.breakdown_updated, routeNames: ['team-needs', 'team_needs_team_share']},
