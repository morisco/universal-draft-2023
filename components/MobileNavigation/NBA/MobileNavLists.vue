<template>
  <div class="mobile-navigation__lists">
    ...
    <NuxtLink
      ...
      @click="changeList"
    >
      <span class="mobile-navigation__lists-title">Big Board by Kevin O'Connor</span>
    ...
    <NuxtLink
      ...
      @click="changeList"
    >
      <span class="mobile-navigation__lists-title">Mock Draft by Kevin O'Connor</span>
    ...
    <NuxtLink
      ...
      @click="changeList"
    >
      <span class="mobile-navigation__lists-title">Team Needs by Matt Dollinger</span>
    ...
    <NuxtLink
      ...
      @click="changeList"
    >
      <span class="mobile-navigation__lists-title">Draft Grades by Kevin O'Connor</span>
