...
export default {
  ...
  methods: {
    enter() {
      ...
      scrollIt(
        this.$refs.viewable.offsetParent.offsetParent.offsetParent.offsetTop +
          this.$refs.viewable.offsetParent.offsetParent.offsetTop +
          this.$refs.viewable.offsetParent.offsetTop +
          this.$refs.viewable.offsetTop +
          this.$refs.viewable.offsetHeight / 2 -
